...
class PlayerAttackPveEvent extends Event{
	...
	public function __construct(private AetherPlayer $player, private PveEntity $entity, private float $damage, private bool $critical = false, private float $knockback = 0.4, private ?ItemAbility $cause = null){ }
	...
	public function getFinalDamage() : float{
		...
		if($this->isMagicDamage()){
			$damage += PveUtils::getFinalMagicDamage($damage, $this->player->getPveData());
		}
