...
class UltimateCarrotCandy extends CarrotCandy {


	public function __construct(ItemIdentifier $identifier, string $name = "Unknown"){
		parent::__construct($identifier, $name);

		$this->initComponent("ultimate_carrot_candy", new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_EQUIPMENT));
	}
