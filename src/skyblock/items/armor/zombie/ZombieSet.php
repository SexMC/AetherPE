...
class ZombieSet extends ArmorSet {
	...
	public function getLore(Item $item) : array{
		return [ //todo ability of this
			...
			"§r§l§5 » §r§5When hit by a projectile, Heal §a+10 " . PveUtils::getHealth(),
